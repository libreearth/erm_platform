defmodule ErmWeb.RoleControllerTest do
  use ErmWeb.ConnCase

  alias Erm.Authorizations

  @create_attrs %{content: %{}, description: "some description", name: "some name", type: "some type", valid_from: "2010-04-17T14:00:00Z", valid_to: "2010-04-17T14:00:00Z"}
  ...
  def fixture(:role) do
    {:ok, role} = Authorizations.create_role(@create_attrs)
    role
  end
