defmodule ErmWeb.ActivityControllerTest do
  use ErmWeb.ConnCase

  alias Erm.Entities

  @create_attrs %{content: %{}, date_from: "2010-04-17T14:00:00Z", date_to: "2010-04-17T14:00:00Z", description: "some description", status: "some status", title: "some title", type: "some type"}
  @update_attrs %{content: %{}, date_from: "2011-05-18T15:01:01Z", date_to: "2011-05-18T15:01:01Z", description: "some updated description", status: "some updated status", title: "some updated title", type: "some updated type"}
  @invalid_attrs %{content: nil, date_from: nil, date_to: nil, description: nil, status: nil, title: nil, type: nil}

  def fixture(:activity) do
    {:ok, activity} = Entities.create_activity(@create_attrs)
    activity
  end
